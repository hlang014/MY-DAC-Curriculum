...
JOIN 
	myownschema.numbers n2 ON n1.index + 1 = n2.index
JOIN
	myownschema.numbers n3 ON n1.index + 2 = n3.index 
ORDER BY 
	n1.index;
--------------------------------------------------------------------------------------------------------------------------------------------------
...
SELECT 
	myownschema.emails.email_id
	
FROM myownschema.emails 
INNER JOIN myownschema.texts
		ON myownschema.emails.email_id = myownschema.texts.email_id;
